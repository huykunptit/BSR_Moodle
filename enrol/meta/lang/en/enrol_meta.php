...
$string['pluginname'] = 'Quiz meta link';
$string['pluginname_desc'] = 'Quiz meta link enrolment plugin synchronises enrolments and roles in two different courses.';
...
$string['wsinvalidcourse'] = 'Quiz id = {$a} does not exist or no permission to link in meta enrolment.';
