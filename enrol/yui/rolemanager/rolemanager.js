YUI.add('moodle-enrol-rolemanager', function(Y) {
    ...
    Y.extend(ROLEPANEL, Y.Base, {
        ...
        initializer : function() {
            ...
            var element = Y.Node.create('<div class="pop-container"><div class="container"><div class="arrow"></div>' +
                                        '<div class="header popover-title" style="margin-bottom: 2rem; border-bottom: 1px solid #0000003d; padding: 1rem 0">' +
                                        ...
                                        '</div><div class="content popover-content form-inline form-group d-flex justify-content-center"></div></div></div>');
