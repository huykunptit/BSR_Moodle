...
require_login();
// C:\inetpub\wwwroot\blocks\cocoon_slider_2\block_cocoon_slider_2.php
include_once ($CFG->dirroot . '/blocks/cocoon_slider_2/block_cocoon_slider_2.php');
// include_once ($CFG->dirroot . '/blocks/cocoon_slider_2/ccn/block_handler/ccn_block_handler.php');
$block = new \block_cocoon_slider_2();
// dd($block);
$block->get_content();
// dd($block->get_content());
