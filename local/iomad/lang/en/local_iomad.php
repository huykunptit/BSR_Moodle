...
$string['nopermissions'] = 'The BSR administrator has not given you permission to do this.';
$string['pluginname'] = 'BSR';
$string['privacy:metadata'] = 'The Local BSR plugin only shows data stored in other locations.';
...
$string['setupiomad'] = 'Start setting up BSR';
