...
if ($result) {
    ...
    echo 'Chức năng này cho phép ghi danh nhiều thí sinh từ file <br> 

                Cột phải chứa mã nhân viên : <b>idnumber</b> của thí sinh cần đăng ký. <br>';
    ...
    $newFilename = $currentDate . '_Filemau_Ghidanhbangfile.csv';
