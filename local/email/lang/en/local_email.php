...
$string['privacy:metadata:local_email:courseid'] = 'Quiz ID';
...
$string['course_not_started_warning_name'] = 'Quiz not started warning';
...
$string['advertise_classroom_based_course_subject'] = 'Quiz {Course_FullName}';
...
<p>{Course_ReportText}</p>';
$string['expire_subject'] = 'Quiz expires';
...
$string['completion_course_user_subject'] = 'Quiz {Course_FullName} has been completed';
