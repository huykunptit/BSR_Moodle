...
$string['report_emails:view'] = 'View the BSR email report';
$string['report_emails:resend'] = 'Resend BSR emails';
$string['pluginname'] = 'Outgoing email report';
$string['privacy:metadata'] = 'The Local BSR email report only shows data stored in other locations.';
