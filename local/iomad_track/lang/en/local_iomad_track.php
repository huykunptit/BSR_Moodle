...
$string['pluginname'] = 'BSR completion tracking';
$string['privacy:metadata'] = 'The Local BSR completion tracking plugin only shows data stored in other locations.';
$string['privacy:metadata:local_iomad_track:id'] = 'Local BSR track id';
$string['privacy:metadata:local_iomad_track:courseid'] = 'Quiz id';
$string['privacy:metadata:local_iomad_track:coursename'] = 'Quiz name.';
...
$string['privacy:metadata:local_iomad_track:timecompleted'] = 'Quiz time completed';
$string['privacy:metadata:local_iomad_track:timeenrolled'] = 'Quiz time enrolled';
$string['privacy:metadata:local_iomad_track:timestarted'] = 'Quiz time started';
$string['privacy:metadata:local_iomad_track:finalscore'] = 'Quiz final score';
...
$string['privacy:metadata:local_iomad_track'] = 'Local BSR track user information';
$string['privacy:metadata:local_iomad_track_certs:id'] = 'Local BSR track certificate record id';
...
$string['privacy:metadata:local_iomad_track_certs'] = 'Local BSR track certificate info';
$string['fixtracklicensetask'] = 'BSR track fix license tracking details adhoc task';
...
$string['importcompletionsfrommoodlefull'] = 'This will run an AdHoc task to import all of the completion information from Moodle to the BSR reporting tables';
$string['importcompletionsfrommoodlefullwitherrors'] = 'This will run an AdHoc task to import SOME of the completion information from Moodle to the BSR reporting tables. Not all courses have completion enabled or criteria set up and their information will be missed out.  If you want to know which courses these are use the check link on the previous page';
