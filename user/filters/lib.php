...
class user_filtering {
    ...
    public function __construct($fieldnames = null, $baseurl = null, $extraparams = null) {
        ...
        if (empty($fieldnames)) {
            ...
            $fieldnames = array('realname' => 1, 'idnumber' => 1, 'email' => 1, 'institution' => 1, 'department' => 1, 'suspended' => 1, 'lastaccess' => 1,
            ...
            if ($userfiltersdefault == '') {
                $userfiltersdefault = array('realname','idnumber','department','profile');
             
                // Otherwise, we split the enabled filters into an array.
            } else {
                $userfiltersdefault = array('realname','idnumber','department','profile');
            }
            // dd($userfiltersdefault);  
    ...
    public function get_field($fieldname, $advanced) {
        ...
        switch ($fieldname) {
            ...
            case 'profile':     return new user_filter_profilefield('profile', get_string('position', 'filters'), $advanced);
