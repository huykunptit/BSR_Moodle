 ...
 */
$string['choosedepartment'] = 'Chọn Phòng/Ban';
$string['searchposition'] = 'Tìm kiếm chức danh';
$string['abouttobeinstalled'] = 'Hiển thị kết quả: ';
$string['showlength'] = 'about to be installed';
...
$string['activities_help'] = 'Activities, such as forums, quizzes and wikis, enable interactive content to be added to the quiz.';
...
$string['addcreator'] = 'Add quiz creator';
$string['adddots'] = 'Add...';
$string['added'] = 'Added {$a}';
$string['addedtogroup'] = 'Added to group "{$a}"';
$string['addedtogroupnot'] = 'Not added to group "{$a}"';
$string['addedtogroupnotenrolled'] = 'Not added to group "{$a}", because not enrolled in quiz';
...
$string['addnewcourse'] = 'Add a new quiz';
...
$string['addresourceoractivity'] = 'Thêm đề thi';
...
$string['adminhelpassigncreators'] = 'Quiz creators can create new quiz';
$string['adminhelpassignsiteroles'] = 'Apply defined site roles to specific users';
$string['adminhelpassignstudents'] = 'Go into a quiz and add students from the admin menu';
...
$string['adminhelpcourses'] = 'Define quiz and categories and assign people to them, edit pending quiz';
...
$string['administratordescription'] = 'Administrators can usually do anything on the site, in all quiz.';
...
$string['allowstealthmodules_help'] = 'If enabled, activities can be made available but not shown in visible sections of the quiz page. If so, links to stealth activities must be provided from elsewhere, such as from a page resource. Stealth activities are still listed in the gradebook and other reports.';
...
$string['areyousuretorestorethisinfo'] = 'Later in this process you will have a choice of adding this backup to an existing quiz or creating a completely new quiz.';
...
$string['availablecourses'] = 'Available quiz';
$string['back'] = 'Back';
$string['backto'] = 'Back to {$a}';
$string['backtocourselisting'] = 'Back to quiz listing';
...
$string['backupadhocpending'] = 'Quiz backup ad hoc task pending';
$string['backupcancelled'] = 'Backup cancelled';
$string['backupcoursefileshelp'] = 'If enabled then quiz files will be included in automated backups';
...
$string['backupfailed'] = 'Some of your quiz weren\'t saved!!';
...
$string['backupincludemoduleshelp'] = 'Choose whether you want to include quiz modules, with or without user data, in automated backups';
...
$string['backupsitefileshelp'] = 'If enabled then site files used in quiz will be included in automated backups';
...
$string['bulkmovecoursessuccess'] = 'Successfully moved {$a->courses} quiz into {$a->category}';
$string['bycourseorder'] = 'By quiz order';
$string['byname'] = 'by {$a}';
...
$string['categories'] = 'Quiz categories';
$string['categoriesandcourses'] = 'Quiz categories and quiz';
$string['category'] = 'Category';
$string['categoryadded'] = 'The category \'{$a}\' was added';
$string['categorybulkaction'] = 'Bulk actions for selected categories';
$string['categorycontents'] = 'Subcategories and quiz';
...
$string['idnumbercoursecategory_help'] = 'The ID number of a quiz category  is only used when matching the category against external systems and is not displayed anywhere on the site. If the category has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['closecourseindex'] = 'Close quiz index';
...
$string['confirmcoursemove'] = 'Are you sure you want to move this quiz ({$a->course}) into this category ({$a->category})?';
$string['considereddigitalminor'] = 'You are too young to create an account on this site.';
$string['content'] = 'Content';
$string['contentexport_aboutthiscourse'] = 'Quiz summary';
...
$string['continuetocourse'] = 'Click here to enter your quiz';
$string['convertingwikitomarkdown'] = 'Converting wiki to Markdown';
$string['cookiesenabled'] = 'Cookies phải được kích hoạt trong trình duyệt của bạn';
...
The other cookie is purely for convenience, usually called MOODLEID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in.';
$string['cookiesenabledonlysession'] = 'Cookies phải được kích hoạt trong trình duyệt của bạn';
...
$string['copycourse'] = 'Copy quiz';
$string['copyingcoursefiles'] = 'Copying quiz files';
$string['copyingsitefiles'] = 'Copying site files used in quiz';
...
$string['course'] = 'Quiz';
$string['courseheader'] = 'Quiz menu';
$string['courseadministration'] = 'Quiz administration';
$string['courseapprovedemail'] = 'Your requested quiz, {$a->name}, has been approved and you have been made a {$a->teacher}.  To access your new quiz, go to {$a->url}';
$string['courseapprovedemail2'] = 'Your requested quiz, {$a->name}, has been approved.  To access your new quiz, go to {$a->url}';
$string['courseapprovedfailed'] = 'Failed to save the quiz as approved!';
$string['courseapprovedsubject'] = 'Your quiz has been approved!';
$string['courseavailable'] = 'This quiz is available to students';
$string['courseavailablenot'] = 'This quiz is not available to students';
$string['coursebackup'] = 'Quiz backup';
$string['coursebulkaction'] = 'Bulk actions for selected quiz';
$string['coursecategories'] = 'Quiz categories';
$string['coursecategory'] = 'Quiz category';
$string['coursecategory_help'] = 'This setting determines the category in which the quiz will appear in the list of quiz.';
$string['coursecategorydeleted'] = 'Deleted quiz category {$a}';
$string['coursecatmanagement'] = 'Quiz and category management';
$string['coursecompletion'] = 'Quiz completion';
$string['coursecompletions'] = 'Quiz completions';
$string['coursecreators'] = 'Quiz creator';
$string['coursecreatorsdescription'] = 'Quiz creators can create new quiz.';
$string['coursedetails'] = 'Quiz details';
$string['coursedisplay'] = 'Quiz layout';
$string['coursedisplay_help'] = 'Quiz sections can be displayed all in one page or split over several pages.';
$string['coursedisplay_single'] = 'Show all sections on one page';
$string['coursedisplay_multi'] = 'Show one section per page';
$string['coursedeleted'] = 'Deleted quiz {$a}';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = 'Legacy quiz files';
$string['coursefilesedit'] = 'Edit legacy quiz files';
$string['coursefileswarning'] = 'Quiz files are deprecated';
$string['coursefileswarning_help'] = 'Quiz files are deprecated since Moodle 2.0, please use external repositories instead as much as possible.';
$string['courseformatdata'] = 'Quiz format data';
$string['courseformats'] = 'Quiz formats';
$string['courseformatoptions'] = 'Formatting options for {$a}';
$string['courseformatudpate'] = 'Update format';
$string['courseprofiles'] = 'Quiz profiles';
$string['coursegrades'] = 'Quiz grades';
$string['coursehelpcategory'] = 'Position the quiz on the quiz listing and may make it easier for students to find it.';
$string['coursehelpforce'] = 'Force the quiz group mode to every activity in the quiz.';
$string['coursehelpformat'] = 'The quiz main page will be displayed in this format.';
$string['coursehelphiddensections'] = 'How the hidden sections in the quiz are displayed to students.';
$string['coursehelpmaximumupload'] = 'Define the largest size of file that can be uploaded in this quiz, limited by the site-wide setting.';
$string['coursehelpnewsitemsnumber'] = 'Number of recent announcements appearing in the latest announcements block on the quiz page. If set to zero, the announcements forum will not be created.';
$string['coursehelpnumberweeks'] = 'Number of sections in the quiz (applies to certain quiz formats only).';
$string['coursehelpshowgrades'] = 'Enable the display of the gradebook. It does not prevent grades from being displayed within the individual activities.';
$string['coursehidden'] = 'This quiz is currently unavailable to students';
$string['courseoverviewfiles'] = 'Quiz image';
$string['courseoverviewfilesext'] = 'Quiz image file extensions';
$string['courseoverviewfileslimit'] = 'Quiz image files limit';
$string['courseoverviewfiles_help'] = 'The quiz image is displayed in My quiz and in the list of available quiz on the Home page. Site administrators can enable additional file types and the use of multiple files. If you use multiple files, they will all be displayed in the list of available quiz in the Home page.';
$string['courseinfo'] = 'Quiz info';
$string['coursenotaccessible'] = 'This quiz does not allow public access';
$string['courselegacyfiles'] = 'Legacy quiz files';
$string['courselegacyfiles_help'] = 'The quiz files area provides some backward compatibility with Moodle 1.9 and earlier.  All files in this area are always accessible to all participants in the quiz (whether you link to them or not) and there is no way to know where any of these files are being used in Moodle.

If you use this area to store quiz files, you can expose yourself to a number of privacy and security issues, as well as experiencing missing files in backups, quiz imports and any time content is shared or re-used.  It is therefore recommended that you do not use this area unless you really know what you are doing.';
$string['courselegacyfiles_link'] = 'coursefiles2';
$string['courselegacyfilesofcourse'] = 'Legacy quiz files: {$a}';
$string['courseoverview'] = 'Quiz overview';
$string['courseoverviewgraph'] = 'Quiz overview graph';
...
$string['coursereject'] = 'Reject a quiz request';
$string['courserejected'] = 'Quiz has been rejected and the requester has been notified.';
$string['courserejectemail'] = 'Sorry, but the quiz you requested has been rejected. Here is the reason provided:

{$a}';
$string['courserejectreason'] = 'Outline your reasons for rejecting this quiz<br />(this will be emailed to the requester)';
$string['courserejectsubject'] = 'Your quiz has been rejected';
$string['coursereport'] = 'Quiz report';
$string['coursereports'] = 'Quiz reports';
$string['courserequest'] = 'Quiz request';
$string['courserequestdetails'] = 'Details of the quiz you are requesting';
$string['courserequestfailed'] = 'For some reason, your quiz request could not be saved';
$string['courserequestintro'] = 'Use this form to request a quiz to be created for you.<br />Try and fill in as much information as you can to allow<br />the administrators to understand your reasons for wanting this quiz.';
$string['courserequestreason'] = 'Reasons for wanting this quiz';
$string['courserequestroleerror'] = 'The creators\' role in new quiz configuration is invalid. Please see <a href="{$a}">user policies</a>.';
$string['courserequestsuccess'] = 'Quiz request submitted.';
$string['courserequestsupport'] = 'Supporting information to help the administrator evaluate this request';
$string['courserequestwarning'] = 'The user requesting this quiz will be automatically enrolled and assigned the role of {$a}.';
$string['courserestore'] = 'Quiz restore';
$string['coursereuse'] = 'Quiz reuse';
$string['courses'] = 'Quiz';
$string['coursesectionsummaries'] = 'Quiz section summaries';
...
$string['coursesettings'] = 'Quiz default settings';
$string['coursesmovedout'] = 'quiz moved out from {$a}';
$string['coursespending'] = 'quiz pending approval';
$string['coursesearch'] = 'Search quiz';
...
$string['coursestart'] = 'Quiz start';
$string['coursesummary'] = 'Quiz summary';
$string['coursesummary_help'] = 'A short description of your quiz. The content you add here is searchable.';
$string['coursetitle'] = 'Course: {$a->course}';
$string['coursetitlebulkediting'] = 'Bulk edit quiz: {$a->course}';
$string['coursetitleediting'] = 'Edit quiz: {$a->course}';
$string['courseupdates'] = 'Quiz updates';
$string['coursevisibility'] = 'Quiz visibility';
$string['coursevisibility_help'] = '* Show: The quiz appears in the list of quiz and students can access it.
* Hide: Access is restricted to teachers and other users with the capability to view hidden quiz.';
...
$string['createnewcourse'] = 'Create new quiz';
...
$string['creatingcoursemodules'] = 'Creating quiz modules';
$string['creatingcourseroles'] = 'Creating quiz level role assignments and overrides';
...
$string['creatingnewcourse'] = 'Creating new quiz';
...
$string['currentcourse'] = 'Current quiz';
$string['currentcourseadding'] = 'Current quiz, adding data to it';
$string['currentcoursedeleting'] = 'Current quiz, deleting it first';
...
$string['defaultcoursestudentdescription'] = 'Students generally have fewer privileges within a quiz.';
$string['defaultcoursestudents'] = 'Students';
$string['defaultcoursesummary'] = 'Write a concise and interesting paragraph here that explains what this quiz is about';
$string['defaultcourseteacher'] = 'Teacher';
$string['defaultcourseteacherdescription'] = 'Teachers can do anything within a quiz, including changing the activities and grading students.';
...
$string['deletecategorycheck'] = 'Are you absolutely sure you want to completely delete this category <b>\'{$a}\'</b>?<br />This will move all quiz into the parent category if there is one, or into Miscellaneous.';
$string['deletecategorycheck2'] = 'If you delete this category, you need to choose what to do with the quiz and subcategories it contains.';
$string['deletecommentbyon'] = 'Delete comment posted by {$a->user} on {$a->time}';
$string['deletecompletely'] = 'Delete completely';
$string['deletecourse'] = 'Delete a quiz';
$string['deletecoursecheck'] = 'Are you absolutely sure you want to completely delete this quiz and all the data it contains?';
...
$string['deletingexistingcoursedata'] = 'Deleting existing quiz data';
...
$string['dndcourse'] = 'You can drag and drop this quiz to alter its sorting or to move it to another category.';
...
$string['dndworkingfiletextlink'] = 'Drag and drop files, text or links onto quiz sections to upload them';
$string['dndworkingfilelink'] = 'Drag and drop files or links onto quiz sections to upload them';
$string['dndworkingfiletext'] = 'Drag and drop files or text onto quiz sections to upload them';
$string['dndworkingfile'] = 'Drag and drop files onto quiz sections to upload them';
$string['dndworkingtextlink'] = 'Drag and drop text or links onto quiz sections to upload them';
$string['dndworkingtext'] = 'Drag and drop text onto quiz sections to upload it';
$string['dndworkinglink'] = 'Drag and drop links onto quiz sections to upload them';
$string['documentation'] = 'Moodle documentation';
$string['dontsortcategories'] = 'Don\'t sort categories';
$string['dontsortcourses'] = 'Don\'t sort quiz';
$string['down'] = 'Down';
...
$string['editcoursesettings'] = 'Edit quiz settings';
...
* Visible to quiz participants - Only participants of quiz you are enrolled in can view your email address.';
$string['emaildisplaycourse'] = 'Visible to quiz participants';
$string['emaildisplaycoursemembersonly'] = '(Visible to other quiz participants)';
...
If you need help, please contact the site administrator,
{$a->admin}';
$string['emailpasswordconfirmationsubject'] = '{$a}: Xác nhận thay đổi mật khẩu';
$string['emailpasswordconfirmmaybesent'] = '<p>Nếu bạn cung cấp tên người dùng hoặc địa chỉ email chính xác, một email đã được gửi đến bạn.</p>
   <p>Email đó chứa các hướng dẫn đơn giản để xác nhận và hoàn tất việc thay đổi mật khẩu này. Nếu bạn vẫn gặp khó khăn, vui lòng liên hệ với quản trị viên của trang web.</p>';
...
$string['emptycmids'] = 'Empty quiz module IDs';
$string['emptydragdropregion'] = 'empty region';
$string['emptysectionids'] = 'Empty section IDs';
$string['enable'] = 'Enable';
$string['encryptedcode'] = 'Encrypted code';
$string['enddate'] = 'Quiz end date';
$string['enddate_help'] = 'The end date doesn’t restrict student access to the quiz. It determines whether a quiz is listed as Past in My quiz.';
$string['english'] = 'English';
$string['enrolmentmethods'] = 'Enrolment methods';
$string['entercourse'] = 'Click to enter this quiz';
...
$string['eventcoursebackupcreated'] = 'Quiz backup created';
...
$string['eventcoursecontentdeleted'] = 'Quiz content deleted';
$string['eventcoursecreated'] = 'Quiz created';
$string['eventcoursedeleted'] = 'Quiz deleted';
$string['eventcourseinformationviewed'] = 'Quiz summary viewed';
$string['eventcoursemodulecreated'] = 'Quiz module created';
$string['eventcoursemoduledeleted'] = 'Quiz module deleted';
$string['eventcoursemoduleupdated'] = 'Quiz module updated';
$string['eventcoursemoduleviewed'] = 'Quiz module viewed';
$string['eventcoursessearched'] = 'quiz searched';
$string['eventcourseresetended'] = 'Quiz reset ended';
$string['eventcourseresetstarted'] = 'Quiz reset started';
$string['eventcourserestored'] = 'Quiz restored';
$string['eventcourseupdated'] = 'Quiz updated';
$string['eventcoursesectioncreated'] = 'Quiz section created';
$string['eventcoursesectiondeleted'] = 'Quiz section deleted';
$string['eventcoursesectionupdated'] = 'Quiz section updated';
$string['eventcoursemoduleinstancelistviewed'] = 'Quiz module instance list viewed';
$string['eventcourseuserreportviewed'] = 'Quiz user report viewed';
$string['eventcourseviewed'] = 'Quiz viewed';
...
$string['eventmycoursesviewed'] = 'My quiz viewed';
...
$string['existingcourse'] = 'Existing quiz';
$string['existingcourseadding'] = 'Existing quiz, adding data to it';
$string['existingcoursedeleting'] = 'Existing quiz, deleting it first';
$string['existingcreators'] = 'Existing quiz creators';
...
$string['findmorecourses'] = 'Find more quiz...';
$string['first'] = 'First';
...
$string['format_help'] = 'The quiz format determines the layout of the quiz page.

* Single activity format - For displaying a single activity or resource (such as a Quiz or SCORM package) on the quiz page
* Social format - A forum is displayed on the quiz page
* Topics format - The quiz page is organised into topic sections
* Weekly format - The quiz page is organised into weekly sections, with the first week starting on the quiz start date';
...
$string['frontpagecourselist'] = 'List of quiz';
$string['frontpagecoursesearch'] = 'Quiz search box';
$string['frontpageenrolledcourselist'] = 'Enrolled quiz';
$string['frontpagedescription'] = 'Site home summary';
$string['frontpagedescriptionhelp'] = 'This summary can be displayed on the site home using the quiz/site summary block.';
...
$string['fulllistofcourses'] = 'All quiz';
$string['fullname'] = 'Full name'; /* @deprecated - Use fullnamequiz or fullnameuser or some own context specific string. */
$string['fullnamecourse'] = 'Quiz full name';
$string['fullnamecourse_help'] = 'The name displayed in My quiz and in the list of available quiz on the Home page.';
...
$string['guestuserinfo'] = 'This user is a special user that allows read-only access to some quiz.';
$string['help'] = 'Help';
...
$string['hiddenoncoursepage'] = 'Available but not shown on quiz page';
$string['hiddensections'] = 'Hidden sections';
$string['hiddensections_help'] = 'Hidden sections can be displayed to students as \'not available\' on the quiz page, or kept completely hidden.';
...
$string['hidefromstudents'] = 'Hide on quiz page';
$string['hideoncoursepage'] = 'Make available but don\'t show on quiz page';
...
$string['checkingcourse'] = 'Checking quiz';
...
$string['childcoursenotfound'] = 'Child quiz not found!';
$string['childcourses'] = 'Child quiz';
$string['choose'] = 'Choose';
$string['choosecourse'] = 'Choose a quiz';
...
$string['courseduration'] = 'Quiz duration';
$string['courseduration_desc'] = 'The quiz duration is used to calculate the default quiz end date. The quiz end date is used for determining whether a quiz should be included in a user\'s list of quiz.  It may also be used by custom reports. Users can still enter the quiz after the end date.';
$string['courseenddateenabled'] = 'Quiz end date enabled by default';
$string['courseenddateenabled_desc'] = 'This setting determines if the quiz end date will be enabled by default for new quiz and set to the date calculated from the quiz duration.';
...
$string['idnumbercourse'] = 'Quiz ID number';
$string['idnumbercourse_help'] = 'Only used to connect the quiz with external systems. Leave blank if you don\'t have an official quiz ID.';
...
$string['importdata'] = 'Import quiz data';
$string['importdataexported'] = 'Exported data from \'from\' quiz successfully.<br /> Continue to import into your \'to\' quiz.';
$string['importdatafinished'] = 'Import complete! Continue to your quiz';
$string['importdatafrom'] = 'Find a quiz to import data from:';
$string['inactive'] = 'Inactive';
$string['include'] = 'Include';
$string['includeallusers'] = 'Include all users';
$string['includecoursefiles'] = 'Include quiz files';
$string['includecourseusers'] = 'Include quiz users';
...
$string['includesitefiles'] = 'Include site files used in this quiz';
$string['includeuserfiles'] = 'Include user files';
$string['increasesections'] = 'Increase the number of sections';
$string['indicator:accessesafterend'] = 'Quiz accessed after end date';
$string['indicator:accessesafterend_help'] = 'This indicator reflects if the student accessed the quiz after the quiz end date.';
$string['indicator:accessesbeforestart'] = 'Quiz accessed before start date';
$string['indicator:accessesbeforestart_help'] = 'This indicator reflects if the student accessed the quiz before the quiz start date.';
$string['indicator:activitiesdue'] = 'Activities due';
$string['indicator:activitiesdue_help'] = 'The user has activities due.';
$string['indicator:anycourseaccess'] = 'Any quiz access';
$string['indicator:anycourseaccess_help'] = 'This indicator reflects access to any quiz that the user is enrolled in.';
...
$string['indicator:anywriteincourse'] = 'Any write action in the quiz';
$string['indicator:anywriteincourse_help'] = 'This indicator represents any write (submit) action taken by the student in any quiz activity.';
...
$string['indicator:completionenabled_help'] = 'This indicator represents that completion tracking has been enabled for this quiz.';
$string['indicator:nostudent'] = 'Student enrolments';
$string['indicator:nostudent_help'] = 'This indicator reflects the availability of students in the quiz.';
$string['indicator:noteacher'] = 'Teacher availability';
$string['indicator:noteacher_help'] = 'This indicator reflects the availability of teachers in the quiz.';
$string['indicator:potentialcognitive'] = 'Quiz potential cognitive depth';
$string['indicator:potentialcognitive_help'] = 'This indicator is based on the potential cognitive depth that could be reached by a student participating in quiz activities.';
$string['indicator:potentialcognitivedef'] = 'Quiz potential cognitive depth';
$string['indicator:potentialcognitivedef_help'] = 'The degree to which the quiz offers "deep" cognitive engagement, e.g. submission of work for feedback, the opportunity to review work by others, and the opportunity to revise and resubmit work.';
$string['indicator:potentialcognitivedef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:potentialsocial'] = 'Quiz potential social breadth';
$string['indicator:potentialsocial_help'] = 'This indicator is based on the potential social breadth that could be reached by the student participating in quiz activities.';
$string['indicator:potentialsocialdef'] = 'Quiz potential social breadth';
$string['indicator:potentialsocialdef_help'] = 'The degree to which the quiz offers "broad" social engagement, interacting with other participants and with the community of practice beyond the class.';
...
$string['lastcourseaccess'] = 'Last access to quiz';
...
$string['listofcourses'] = 'List of quiz';
...
<p>For full access to quiz you\'ll need to create yourself an account.</p>
...
$string['maincoursepage'] = 'Main quiz page';
...
$string['managecombined'] = 'Manage quiz categories and quiz';
$string['managecategories'] = 'Manage quiz categories';
...
$string['managecourses'] = 'Manage quiz';
...
$string['maxsectionslimit'] = 'Cannot create new section as it would exceed the maximum number of sections allowed for this quiz ({$a}).';
...
$string['maximumupload_help'] = 'The maximum file size allowed for student uploads to the quiz. Additionally, you can further restrict the maximum upload size for each activity.';
$string['maxnumberweeks'] = 'Maximum number of sections';
$string['maxnumberweeks_desc'] = 'The maximum value in the number of sections drop-down menu (applies to certain quiz formats only).';
$string['maxnumcoursesincombo'] = 'Browse <a href="{$a->link}">{$a->numberofcourses} quiz</a>.';
...
$string['memberincourse'] = 'People in the quiz';
...
$string['messageprovider:coursecompleted'] = 'Quiz completed';
$string['messageprovider:coursecontentupdated'] = 'Quiz content changes';
$string['messageprovider:courserequestapproved'] = 'Quiz creation request approval notification';
$string['messageprovider:courserequested'] = 'Quiz creation request notification';
$string['messageprovider:courserequestrejected'] = 'Quiz creation request rejection notification';
...
$string['modvisible_help'] = '* Show on quiz page: Available to students (subject to any access restrictions which may be set).
* Hide on quiz page: Not available to students.';
$string['modvisiblewithstealth'] = 'Availability';
$string['modvisiblewithstealth_help'] = '* Show on quiz page: Available to students (subject to any access restrictions which may be set).
* Hide on quiz page: Not available to students.
* Make available but don\'t show on quiz page: Available to students if you provide a link. Activities will still appear in the gradebook and other reports.';
$string['modvisiblehiddensection'] = 'Availability';
$string['modvisiblehiddensection_help'] = '* Hide on quiz page: Not available to students.
* Make available but don\'t show on quiz page: Available to students if you provide a link. Activities will still appear in the gradebook and other reports.';
...
$string['movecourseto'] = 'Move quiz to:';
...
$string['moveselectedcoursesto'] = 'Move selected quiz to...';
...
$string['nocourses'] = 'No quiz';
$string['nocoursesfound'] = 'No quiz were found with the words \'{$a}\'';
$string['nocoursestarttime'] = 'The quiz does not have a start date.';
$string['nocoursesyet'] = 'No quiz in this category';
...
$string['nofilesyet'] = 'No files have been uploaded to your quiz yet';
...
$string['noimagesyet'] = 'No images have been uploaded to your quiz yet';
$string['nologsfound'] = 'No logs have been found';
$string['nomatchingusers'] = 'No users match \'{$a}\'';
$string['nomorecourses'] = 'No more matching quiz could be found';
$string['nomoreidnumber'] = 'Not using an idnumber to avoid collisions';
$string['none'] = 'None';
$string['noneditingteacher'] = 'Non-editing teacher';
$string['noneditingteacherdescription'] = 'Non-editing teachers can teach in quiz and grade students, but may not alter activities.';
$string['nonstandard'] = 'Non-standard';
$string['nopendingcourses'] = 'There are no quiz pending approval';
$string['nopotentialadmins'] = 'No potential admins';
$string['nopotentialcreators'] = 'No potential quiz creators';
...
$string['nosite'] = 'Could not find site-level quiz';
$string['nostudentsfound'] = 'No {$a} found';
$string['nostudentsingroup'] = 'There are no students in this group yet';
$string['nostudentsyet'] = 'There are no students enrolled in this quiz.';
$string['nosuchemail'] = 'No such email address';
$string['notavailable'] = 'Not available';
$string['notavailablecourse'] = '{$a} is not available';
$string['noteachersyet'] = 'No teachers in this quiz yet';
$string['noteachingupcomingcourses'] = 'Upcoming quiz have no teachers or students';
$string['notenrolled'] = '{$a} is not enrolled in this quiz.';
$string['notenrolledprofile'] = 'This profile is not available because this user is not enrolled in this quiz.';
...
$string['noteuserschangednonetocourse'] = '<strong>Note:</strong> quiz users need to be restored when restoring user data (in activities, files or messages). This setting has been changed for you.';
...
$string['novalidcourses'] = 'No valid quiz to be shown';
$string['now'] = 'now';
$string['numattempts'] = '{$a} failed login attempt(s)';
$string['numberofcourses'] = 'Number of quiz';
...
$string['opendrawerindex'] = 'Open quiz index';
...
$string['parentcoursenotfound'] = 'Parent quiz not found!';
...
$string['passwordextlink'] = 'Liên kết sau đây đã được cung cấp để khôi phục mật khẩu bị mất của bạn. Điều này sẽ đưa bạn ra khỏi Moodle.';
$string['passwordforgotten'] = 'Quên mật khẩu';
$string['passwordforgotteninstructions'] = 'Thông tin của bạn phải được tìm thấy trong cơ sở dữ liệu người dùng. Vui lòng nhập <strong>hoặc</strong> tên người dùng của bạn hoặc địa chỉ email đã đăng ký của bạn vào ô thích hợp. Không cần phải nhập cả hai.';
$string['passwordforgotteninstructions2'] = 'Để đặt lại mật khẩu của bạn, hãy gửi tên người dùng hoặc địa chỉ email của bạn dưới đây. Nếu chúng tôi có thể tìm thấy bạn trong cơ sở dữ liệu, một email sẽ được gửi đến địa chỉ email của bạn, với hướng dẫn để có quyền truy cập lại.';
$string['passwordchanged'] = 'Mật khẩu đã được thay đổi';
$string['passwordnohelp'] = 'Không có sự trợ giúp nào để tìm mật khẩu bị mất của bạn. Vui lòng liên hệ với quản trị viên Moodle của bạn.';
$string['passwordpolicynomatch'] = 'Mật khẩu hiện tại của bạn không còn phù hợp với chính sách mật khẩu đã đặt.
   {$a}';
$string['passwordrecovery'] = 'Có, giúp tôi đăng nhập';
$string['passwordsdiffer'] = 'Các mật khẩu này không khớp';
$string['passwordsent'] = 'Mật khẩu đã được gửi';
$string['passwordset'] = 'Mật khẩu của bạn đã được đặt.';
$string['passwordsenttext'] = '<p>Đã gửi một email đến địa chỉ của bạn tại {$a->email}.</p>
   <p><b>Vui lòng kiểm tra email của bạn để nhận mật khẩu mới</b></p>
   <p>Mật khẩu mới đã được tạo tự động, vì vậy bạn có thể muốn
   <a href="{$a->link}">thay đổi nó thành thứ dễ nhớ hơn</a>.</p>';
...
$string['paymentrequired'] = 'This quiz requires a payment for entry.';
$string['payments'] = 'Payments';
$string['paymentsorry'] = 'Thank you for your payment!  Unfortunately your payment has not yet been fully processed, and you are not yet registered to enter the quiz "{$a->fullname}".  Please try continuing to the quiz in a few seconds, but if you continue to have trouble then please alert the {$a->teacher} or the site administrator';
$string['paymentthanks'] = 'Thank you for your payment!  You are now enrolled in your quiz:<br />"{$a}"';
...
$string['restrictaccess'] = 'Thiết lập ca thi';
...
$string['potentialcreators'] = 'Potential quiz creators';
...
$string['profilenotshown'] = 'This profile description will not be shown until this person is enrolled in at least one quiz.';
...
$string['relativedatesmode_help'] = 'Display quiz or activity dates relative to the user\'s start date in the quiz.

The user\'s quiz start date will be their enrolment start date, unless they are enrolled before the quiz begins in which case their start date will be the quiz start date.

WARNING: This is an experimental feature and not all activities may support it. Once the quiz has been created, this quiz setting can no longer be changed.';
$string['relativedatesmode_warning'] = '<strong>Warning:</strong> Relative dates mode cannot be changed once the quiz has been created.';
$string['reload'] = 'Reload';
$string['remoteappuser'] = 'Remote {$a} User';
$string['remove'] = 'Remove';
$string['removeadmin'] = 'Remove admin';
$string['removecreator'] = 'Remove quiz creator';
...
$string['requestcourse'] = 'Request a quiz';
$string['requestedby'] = 'Requested by';
$string['requestedcourses'] = 'Requested quiz';
$string['requestreason'] = 'Reason for quiz request';
$string['requests'] = 'Requests';
$string['required'] = 'Required';
$string['requirespayment'] = 'This quiz requires payment for access';
$string['resendemail'] = 'Resend email';
$string['reset'] = 'Reset';
$string['resetcomponent'] = 'Component';
$string['resetcourse'] = 'Reset quiz';
$string['resetinfo'] = 'This page allows you to empty a quiz of user data, while retaining the activities and other settings.  Please be warned that by choosing items below and submitting this page you will delete your chosen user data from this quiz forever!';
...
$string['resortcourses'] = 'Sort quiz';
...
$string['resources_help'] = 'Resource types enable almost any kind of web content to be inserted into the quiz.';
...
$string['restorecoursenow'] = 'Restore this quiz now!';
...
$string['rolerenaming_help'] = 'This setting allows the displayed names for roles used in the quiz to be changed. Only the displayed name is changed - role permissions are not affected.  New role names will appear on the quiz participants page and elsewhere within the quiz. If the renamed role is one that the administrator has selected as a quiz manager role, then the new role name will also appear as part of the quiz listings.';
$string['roles'] = 'Roles';
$string['rss'] = 'RSS';
...
$string['savechangesandreturntocourse'] = 'Save and return to quiz';
...
$string['scalestandard_help'] = 'A standard scale is available site-wide, for all quiz.';
$string['scalestandard_link'] = 'grade/scale';
$string['scalestip'] = 'To create custom scales, use the \'Scales...\' link in your quiz administration menu.';
$string['scalestip2'] = 'To create custom scales, click the Grades link in the quiz administration menu, then choose Edit, Scales.';
$string['screenshot'] = 'Screenshot';
$string['search'] = 'Tìm kiếm'; // TODO MDL-34652 rename to searchforums and move to mod_forum.
...
$string['searchbyemail'] = 'Tìm theo email';
$string['searchbyusername'] = 'Tìm theo tên đăng nhập';
$string['searchcoursecategories'] = 'Search categories';
$string['searchcourses'] = 'Search quiz';
...
$string['selectacourse'] = 'Select a quiz';
$string['selectacoursesite'] = 'Select a quiz or site';
...
$string['selectcoursesortby'] = 'Select how you would like to sort quiz';
...
$string['share'] = 'Share';
$string['shortname'] = 'Short name'; /* @deprecated MDL-34652 - Use shortnamequiz or shortnameuser or some own context specific string. */
$string['shortnamecollisionwarning'] = '[*] = This shortname is already in use by a quiz and will need to be changed upon approval';
$string['shortnamecourse'] = 'Quiz short name';
$string['shortnamecourse_help'] = 'The name displayed in areas with limited space. It must be unique.';
$string['shortnametaken'] = 'Short name is already used for another quiz ({$a})';
...
$string['showactivitydates_help'] = 'Show activity dates on the quiz page.';
$string['showadvancededitor'] = 'Advanced';
$string['showadvancedsettings'] = 'Show advanced settings';
$string['showall'] = 'Show all {$a}';
$string['showallcourses'] = 'Show all quiz';
$string['showallusers'] = 'Show all users';
$string['showblockcourse'] = 'Show list of quiz containing block';
...
$string['showdescription'] = 'Display description on quiz page';
$string['showdescription_help'] = 'If enabled, the description above will be displayed on the quiz page just below the link to the activity or resource.';
$string['showgrades'] = 'Show gradebook to students';
$string['showgrades_help'] = 'Allow students to view a list of all their grades in the quiz.';
$string['showingacourses'] = 'Showing all {$a} quiz';
$string['showingxofycourses'] = 'Showing quiz {$a->start} to {$a->end} of {$a->total} quiz';
$string['showlistofcourses'] = 'Show list of quiz';
$string['showmodulecourse'] = 'Show list of quiz containing activity';
$string['showoncoursepage'] = 'Show on quiz page';
...
$string['sitefilesused'] = 'Site files used in this quiz';
...
$string['skiptocourselisting'] = 'Skip to the quiz listings';
$string['skiptocoursedetails'] = 'Skip to the detailed quiz information';
$string['socialheadline'] = 'Social forum - latest topics';
$string['someallowguest'] = 'Một số bài kiểm tra có thể cho phép khách truy cập';
...
$string['starpending'] = '([*] = quiz pending approval)';
$string['startdate'] = 'Quiz start date';
$string['startdate_help'] = 'This date determines the start of the first week for a quiz in weekly format. It is also the start date for logs of quiz activities.

If you reset the quiz and change this date, all dates in the quiz will be moved in relation to the new start date.';
...
$string['statsnodata'] = 'There is no available data for that combination of quiz and time period.';
$string['statsnodatauser'] = 'There is no available data for that combination of quiz, user and time period.';
...
$string['statsreport11'] = 'Most active quiz';
$string['statsreport12'] = 'Most active quiz (weighted)';
$string['statsreport13'] = 'Most participatory quiz (enrolments)';
$string['statsreport14'] = 'Most participatory quiz (posts/views)';
...
$string['statsreport9'] = 'Logins (site quiz)';
...
$string['studentnotallowed'] = 'Sorry, but you can not enter this quiz as \'{$a}\'';
...
$string['summary_help'] = 'The idea of a summary is a short text to prepare students for the activities within the topic or week. The text is shown on the quiz page under the section name.';
...
$string['switchroleto_help'] = 'Choose a role to get an idea of how someone with that role will see this quiz.
...
$string['timesplitting:deciles_help'] = 'This analysis interval divides the quiz into tenths (10 equal parts), with each prediction being based on the data of only the most recent previous tenth.';
$string['timesplitting:decilesaccum'] = 'All previous tenths';
$string['timesplitting:decilesaccum_help'] = 'This analysis interval divides the quiz into tenths (10 equal parts), with each prediction being based on the accumulated data of all previous tenths.';
...
$string['timesplitting:quarters_help'] = 'This analysis interval divides the quiz into quarters (4 equal parts), with each prediction being based on the data of only the most recent previous quarter.';
$string['timesplitting:quartersaccum'] = 'All previous quarters';
$string['timesplitting:quartersaccum_help'] = 'This analysis interval divides the quiz into quarters (4 equal parts), with each prediction being based on the accumulated data of all previous quarters.';
$string['timesplitting:singlerange'] = 'From start to end';
$string['timesplitting:singlerange_help'] = 'This analysis interval considers the entire quiz as a single span.';
...
$string['timesplitting:tenpercentafterstart_help'] = 'This analysis interval generates a prediction after the 10% of the quiz is completed.';
$string['thanks'] = 'Thanks';
$string['theme'] = 'Theme';
$string['themes'] = 'Themes';
$string['themesaved'] = 'New theme saved';
$string['thereareno'] = 'There are no {$a} in this quiz';
$string['therearecourses'] = 'There are {$a} quiz';
$string['thiscategory'] = 'This category';
$string['thiscategorycontains'] = 'This category contains';
$string['time'] = 'Time';
$string['timecreated'] = 'Time created';
$string['timecreatedcourse'] = 'Quiz time created';
...
$string['unexistingcmid'] = 'Quiz module ID not found';
$string['unexistingsectionid'] = 'Quiz section ID not found';
...
$string['updatethiscourse'] = 'Update this quiz';
...
$string['usingexistingcourse'] = 'Using existing quiz';
$string['validatehtml'] = 'Validate HTML';
$string['valuealreadyused'] = 'This value has already been used.';
$string['version'] = 'Version';
$string['view'] = 'View';
$string['viewing'] = 'Viewing:';
$string['viewallcourses'] = 'View all quiz';
$string['viewallcoursescategories'] = 'View all quiz and categories';
...
$string['visible_help'] = 'This setting determines whether the quiz appears in the list of quiz. Apart from teachers and administrators, users are not allowed to enter the quiz.';
...
$string['writingcoursedata'] = 'Writing quiz data';
...
$string['youneedtoenrol'] = 'To perform that action you need to enrol in this quiz.';
...
$string['exporterrorquestions'] = 'Tải danh sách câu hỏi lỗi';
...
$string['msnid'] = 'MSN ID';
$string['coursepreferences'] = 'Quiz preferences';
