...
$string['cachedef_coursecat'] = 'Quiz categories lists for particular user';
$string['cachedef_coursecatrecords'] = 'Quiz categories records';
$string['cachedef_coursesectionspreferences'] = 'Quiz section preferences';
$string['cachedef_coursecattree'] = 'Quiz categories tree';
$string['cachedef_coursecompletion'] = 'Quiz completion status';
...
$string['cachedef_course_image'] = 'Quiz images';
...
$string['cachedef_groupdata'] = 'Quiz group information';
...
$string['cachedef_gradesetting'] = 'Quiz grade setting';
