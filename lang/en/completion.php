...
$string['coursecomplete'] = 'Quiz complete';
$string['coursecompleted'] = 'Quiz completed';
...
$string['coursecompletionnavigation'] = 'Quiz completion tertiary navigation';
$string['coursegrade'] = 'Quiz grade';
$string['coursesavailable'] = 'Quiz available';
...
$string['err_nocourses'] = 'Quiz completion is not enabled for any other courses, so none can be displayed. You can enable course completion in the course settings.';
...
$string['eventcoursecompleted'] = 'Quiz completed';
$string['eventcoursecompletionupdated'] = 'Quiz completion updated';
$string['eventcoursemodulecompletionupdated'] = 'Quiz activity completion updated';
...
$string['overallaggregation_all'] = 'Quiz is complete when ALL conditions are met';
$string['overallaggregation_any'] = 'Quiz is complete when ANY of the conditions are met';
