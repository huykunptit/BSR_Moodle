...
$string['actenrolshhdr'] = 'Available quiz enrolment plugins';
...
$string['assignnotpermitted'] = 'You do not have permission or can not assign roles in this quiz.';
...
$string['defaultenrol'] = 'Add instance to new quiz';
$string['defaultenrol_desc'] = 'It is possible to add this plugin to all new quiz by default.';
$string['deleteinstanceconfirm'] = 'You are about to delete the enrolment method "{$a->name}". All {$a->users} users currently enrolled using this method will be unenrolled and any quiz-related data such as users\' grades, group membership or forum subscriptions will be deleted.

Are you sure you want to continue?';
$string['deleteinstanceconfirmself'] = 'Are you really sure you want to delete instance "{$a->name}" that gives you access to this quiz? It is possible that you will not be able to access this quiz if you continue.';
...
$string['disableinstanceconfirmself'] = 'Are you really sure you want to disable instance "{$a->name}" that gives you access to this quiz? It is possible that you will not be able to access this quiz if you continue.';
...
$string['enrolnotpermitted'] = 'You do not have permission or are not allowed to enrol someone in this quiz';
...
$string['errorenrolcohort'] = 'Error creating cohort sync enrolment instance in this quiz.';
$string['errorenrolcohortusers'] = 'Error enrolling cohort members in this quiz.';
...
$string['eventuserenrolmentcreated'] = 'User enrolled in quiz';
$string['eventuserenrolmentdeleted'] = 'User unenrolled from quiz';
...
$string['instanceeditselfwarningtext'] = 'You are enrolled into this quiz through this enrolment method, changes may affect your access to this quiz.';
...
$string['noguestaccess'] = 'Guests cannot access this quiz. Please log in.';
$string['none'] = 'None';
$string['notenrollable'] = 'You cannot enrol yourself in this quiz.';
$string['notenrolledusers'] = 'Other users';
$string['otheruserdesc'] = 'The following users are not enrolled in this quiz but do have roles, inherited or assigned within it.';
...
$string['rolefromthiscourse'] = '{$a->role} (Assigned in this quiz)';
$string['rolefrommetacourse'] = '{$a->role} (Inherited from parent quiz)';
$string['rolefromcategory'] = '{$a->role} (Inherited from quiz category)';
$string['rolefromsystem'] = '{$a->role} (Assigned at site level)';
$string['sendfromcoursecontact'] = 'From the quiz contact';
...
$string['unassignnotpermitted'] = 'You do not have permission to unassign roles in this quiz';
$string['unenrol'] = 'Unenrol';
$string['unenrolleduser'] = 'The user "{$a->fullname}" was unenrolled from the quiz';
$string['unenrolconfirm'] = 'Do you really want to unenrol "{$a->user}" (previously enrolled via "{$a->enrolinstancename}") from "{$a->course}"?';
$string['unenrolme'] = 'Unenrol me from this quiz';
$string['unenrolnotpermitted'] = 'You do not have permission to unenrol this user from the quiz.';
...
$string['extremovedaction_help'] = 'Select action to carry out when user enrolment disappears from external enrolment source. Please note that some user data and settings are purged from quiz during quiz unenrolment.';
$string['extremovedsuspend'] = 'Disable quiz enrolment';
$string['extremovedsuspendnoroles'] = 'Disable quiz enrolment and remove roles';
$string['extremovedkeep'] = 'Keep user enrolled';
$string['extremovedunenrol'] = 'Unenrol user from quiz';
...
$string['privacy:metadata:user_enrolments:status'] = 'The status of the user enrolment in a quiz';
...
$string['youenrolledincourse'] = 'You are enrolled in the quiz.';
$string['youunenrolledfromcourse'] = 'You are unenrolled from the quiz "{$a}".';

// Deprecated since Moodle 4.0.
$string['proceedtocourse'] = 'Proceed to quiz content';
