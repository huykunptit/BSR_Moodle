...
$string['aria:coursecategory'] = 'Quiz category';
$string['aria:courseimage'] = 'Quiz image';
$string['aria:courseshortname'] = 'Quiz short name';
$string['aria:coursename'] = 'Quiz name';
$string['aria:defaulttab'] = 'Default activities';
$string['aria:favourite'] = 'Quiz is starred';
...
$string['courseaccess'] = 'Quiz access';
$string['coursealreadyfinished'] = 'Quiz already finished';
...
$string['courseparticipants'] = 'Quiz participants';
...
$string['privacy:completionpath'] = 'Quiz completion';
$string['privacy:favouritespath'] = 'Quiz starred information';
...
$string['target:noteachingactivity'] = 'Quiz at risk of not starting';
...
$string['targetlabelteachingno'] = 'Quiz at risk of not starting';
