...
$string['cannotdeletecategorycourse'] = 'Quiz \'{$a}\' failed to be deleted.';
...
$string['cannothaveparentcate'] = 'Quiz category cannot have parent!';
...
$string['coursegroupunknown'] = 'Quiz corresponding to group {$a} not specified';
...
$string['invalidsection'] = 'Quiz module record contains invalid section';
...
$string['requireloginerror'] = 'Quiz or activity not accessible.';
