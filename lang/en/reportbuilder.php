...
$string['coursefullnamewithlink'] = 'Quiz full name with link';
$string['courseidnumberewithlink'] = 'Quiz ID number with link';
$string['courseshortnamewithlink'] = 'Quiz short name with link';
