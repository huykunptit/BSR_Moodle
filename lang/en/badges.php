...
$string['completionnotenabled'] = 'Quiz completion is not enabled for this course, so it cannot be included in badge criteria. Course completion may be enabled in the course settings.';
...
$string['coursebadgesdisabled'] = 'Quiz badges are not enabled on this site.';
...
$string['criteria_4'] = 'Quiz completion';
...
$string['error:nocourses'] = 'Quiz completion is not enabled for any of the courses in this site, so none can be displayed. Course completion may be enabled in the course settings.';
