...
if (isset($_GET['bui_editid'])) {
  ...
  // Add the doctype to the 'ccn_lc_vb' content
$templatecontext['ccn_lc_vb'] = '<!doctype html>' . $templatecontext['ccn_lc_vb'];

// You can also debug the $templatecontext using dd() after adding the doctype
// dd($templatecontext);
