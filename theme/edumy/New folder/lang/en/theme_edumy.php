...
$string['configtitle'] = 'BSR settings';
$string['choosereadme'] = 'BSR Premium Moodle Theme';
...
$string['config_color_course_card'] = 'Quiz card';
$string['config_color_course_title'] = 'Quiz title';
$string['config_color_course_price'] = 'Quiz price';
$string['config_color_course_enrol_btn'] = 'Quiz enrol button';
...
$string['course_navigation'] ='Quiz Navigation';
...
$string['courseliststyle'] = 'Quiz list style';
$string['courseliststyle_desc'] = 'The style for the quiz category view.';
...
$string['library_list_desc'] = 'Display a library list (list of quiz categories) in the header.';
...
$string['course_content_enroled_only'] = 'Quiz Content access';
$string['course_content_enroled_only_desc'] = '(Topics format only) - Choose whether to display quiz content to all users, or only those enroled in the course. This is helpful you want to allow guest access to quiz pages, but hide the list of quiz content, topics, sections, and activity names from unenroled users.';
...
$string['coursecat_enrolments'] = 'Quiz enrolments';
$string['coursecat_enrolments_desc'] = 'Show the number of students enroled in a course.';
$string['coursecat_announcements'] = 'Quiz news items';
$string['coursecat_announcements_desc'] = 'Show the number of quiz announcements in a course.';
$string['coursecat_prices'] = 'Quiz price';
$string['coursecat_prices_desc'] = 'Show quiz prices in category lists and blocks.';
$string['coursecat_settings'] = 'Quiz category settings';
$string['single_course_settings'] = 'Single quiz settings';
$string['course_single_style'] = 'Single quiz style';
$string['course_single_style_desc'] = 'Select the style to use on single courses.';
$string['course_start_date'] = 'Quiz start date';
$string['course_start_date_desc'] = 'Display the start date in single quiz pages, above the quiz content.';
$string['course_category'] = 'Quiz category';
$string['course_category_desc'] = 'Display the category in single quiz pages, above the quiz content.';
$string['seo'] = 'SEO';
...
$string['incourse_layout'] = 'In quiz layout';
$string['incourse_layout_desc'] = 'The layout that should be used when a user is within a quiz (eg accessing individual quiz activities, resources, or content). Custom blocks may not be displayed when using the Dashboard layout.';
$string['coursemainpage_layout'] = 'Quiz main page layout';
$string['coursemainpage_layout_desc'] = 'The layout that should be used when a user is on a quiz main page. Custom blocks may not be displayed when using the Dashboard layout.';
$string['singlecourse_blocks'] = 'Quiz block visibility';
$string['singlecourse_blocks_desc'] = 'Choose whether to display blocks added to courses on all pages of the course, or only on the main quiz page. Use this setting to prevent blocks from appearing on similar quiz pages (such as the Participants page and User pages). This setting affects all blocks added to courses, not just Cocoon blocks.';
...
$string['course_enrolment_payment'] = 'Quiz enrolment payment';
$string['course_enrolment_payment_desc'] = 'Settings for quiz enrolment preferences. Do all courses require payment, or are some free? This setting dictates how quiz enrolment will work and be displayed.';
...
$string['general_course_settings'] = 'General quiz settings';
$string['course_ratings'] = 'Quiz ratings';
$string['course_ratings_desc'] = 'Settings for quiz star ratings.';
...
$string['coursesiamteaching'] = 'Quiz I\'m teaching';
$string['coursesiamtaking'] = 'Quiz I\'m taking';
...
$string['start'] = 'Start';
$string['login_welcome'] = 'Đăng nhập vào trang';
$string['login'] = 'Đăng nhập';
$string['login_no_account'] = 'Don\'t have an account?';
$string['signup'] = 'Sign up!';
$string['search_courses'] = 'Search quiz...';
$string['forgot_password'] = 'Quên mật khẩu ?';
$string['or'] = 'Or';
$string['login_register'] = 'Đăng nhập/Đăng ký';
...
$string['course_buy_access'] = 'Paid quiz entry';
...
$string['total'] = 'Total';
$string['total_courses'] = 'Quiz';
$string['price'] = 'Price';
$string['course_id'] = 'Quiz ID';
...
$string['course_content'] = 'Quiz Content';
...
$string['has_accessed_quiz'] = 'has accessed quiz(s)';
