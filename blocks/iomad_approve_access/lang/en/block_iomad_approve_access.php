...
/**
 * @package    Block BSR Approve Access
 * @copyright  2011 onwards E-Learn Design Limited
 * @author     Derick Turner
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['iomad_approve_access:addinstance'] = 'Add an BSR approve access block';
$string['iomad_approve_access:approve'] = 'Approve access to a user to an approval activity';
$string['iomad_approve_access:myaddinstance'] = 'Add an BSR approve access block to my moodle page';
...
$string['pluginname'] = 'BSR approve training events';
$string['privacy:metadata'] = 'The BSR Approve Access block only shows data stored in other locations.';
...
$string['privacy:metadata:block_iomad_approve_access:courseid'] = 'Quiz id';
...
$string['privacy:metadata:block_iomad_approve_access'] = 'BSR manager approve access block';
