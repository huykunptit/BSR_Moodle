...
$string['uploadusertemplate'] = 'Upload user template';
$string['departmentandpositoncode'] = 'Department and Position Code';
...
$string['autocourses_help'] = 'This is the list of courses which users created using the local BSR Signup process will automatically get enrolled on.';
...
$string['companydomains_help'] = 'This is the list of company email domains which will be used to auto assign users to this company through the local BSR signup plugin.';
...
$string['couldnotdeletecourse'] = 'Quiz could not be deleted';
$string['couldnotremovecoursefromcompany'] = 'Quiz could not be removed from the company';
...
$string['companylogo_desc'] = 'A full logo to be used as decoration for the <i>currently selected</i> company by some themes (such as core and BSR themes). This image can be quite high resolution because it will be scaled down for use (and cached for performance). Logos that are wider than they are high usually give better results.';
...
$string['coursecreatedok'] = 'Quiz was created successfully';
$string['courseislicensedrequired'] = 'Required for a licensed course';
$string['coursemanagement'] = 'Quiz';
$string['coursenamesearch'] = 'Search by course name';
$string['coursegroup'] = 'Quiz group for ';
$string['courses'] = 'Available Courses';
$string['coursesmatching'] = 'Quiz matching \'{$a}\'';
$string['courseusers'] = 'Quiz Users';
...
$string['dashboard'] = 'BSR dashboard';
...
$string['deletecourse_successful'] = 'Quiz was deleted successfully';
...
$string['departmentshortname'] = 'Department code';
...
$string['edit_companies_title'] = 'BSR company settings';
...
$string['educator'] = 'Quiz educator';
$string['educator_help'] = 'Quiz educators get teacher type roles within company courses.';
$string['educatorreusable'] = 'Quiz educator - reusable';
$string['emailfromraw'] = 'Email sent from';
$string['emailpasswordstask'] = 'Email out passwords for newly created BSR users';
...
$string['enrolcoursetype'] = 'Quiz enrolment type';
...
$string['iomadcapabilities_boiler'] = 'Please be aware that the capabilities for the BSR system are fairly complex and disabling one of these may not completely take away the capability from the role you are editing.  You are advised to <b>test</b> any role changes you make to ensure that they work as you expect.';
$string['iomaddashboard'] = 'BSR dashboard';
$string['iomad_company_admin:addinstance'] = 'Add a new BSR company admin block';
...
$string['iomad_company_admin:manageallcourses'] = 'Manage BSR course settings for all companies and courses';
$string['iomad_company_admin:managecourses'] = 'Manage BSR course settings';
...
$string['iomad_company_admin:manageframeworks'] = 'Manage BSR competency framework settings';
$string['iomad_company_admin:managetemplates'] = 'Manage BSR learning plan template settings';
$string['iomad_company_admin:myaddinstance'] = 'Add a new BSR company admin block to the users dashboard';
$string['iomad_company_admin:restrict_capabilities'] = 'Restrict BSR role capabilties for company';
...
$string['frameworksettings'] = 'Manage BSR framework settings';
...
$string['licensecutoffdate'] = 'Quiz cut off date';
...
$string['listroles'] = 'Show BSR roles';
...
$string['iomad_company_courses_title'] = 'Manage BSR course settings';
$string['iomad_company_frameworks_title'] = 'Manage BSR competency framework settings';
$string['iomad_company_templates_title'] = 'Manage BSR competency template settings';
$string['iomad_courses_title'] = 'Manage BSR course settings';
...
$string['pluginname'] = 'BSR Company / User Admin';
...
$string['privacy:metadata'] = 'The BSR Company admin block only shows data stored in other locations.';
...
$string['templatesettings'] = 'Manage BSR template settings';
$string['theoptionsbelow'] = '<p><b>NOTE: The options below may only work with the BSR themes</b></p>';
...
$string['upload_no_company_no_courses'] = 'Quiz can only be selected when a company is selected.';
...
// Role stuff
$string['archetypeclientadministrator_role'] = 'BSR client administrator';
$string['clientadministrator_role'] = 'BSR client administrator';
