...
class block_cocoon_course_categories extends block_base {
    ...
    function get_content() {
        ...
        <section id="our-courses" class="our-courses pt650-992" data-ccn-c="color_bg" data-ccn-co="bg" >
      		<div class="container">
      			<div class="row">
      				<div class="col-lg-12">
      					'.$this->content->style.'
              ...
              <div class="row">
                <div class="col-lg-6 offset-lg-3">
                  <div class="courses_all_btn text-center">
                    <a data-ccn="button_text" data-ccn-c="color_btn" data-ccn-cv="'.$this->content->color_btn.'" data-ccn-bdrrd="button_bdrrd" class="btn btn-transparent ccnLcEl--i" href="'.$CFG->wwwroot .'/course/index.php?perpage=24&browse=categories&page=0" style="border-radius:'.$this->content->button_bdrrd.'px;">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'</a>
                  </div>
                </div>
              </div>
            </div>';
