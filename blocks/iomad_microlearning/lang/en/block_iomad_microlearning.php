...
$string['copy'] = ' (copy)';
$string['cmid'] = 'Quiz module ID';
$string['cmid_help'] = 'Quiz module ID number into this field for the unique course section.  You must define either this or the Section ID value.';
...
$string['crontask'] = 'BSR microlearning cron';
...
$string['iomad_microlearning:view'] = 'View BSR microlearning';
...
$string['pluginname'] = 'BSR microlearning threads';
...
$string['sectionid'] = 'Quiz section ID';
