...
class block_cocoon_faqs extends block_base {
    ...
    function specialization() {
        ...
        if (empty($this->config)) {
          ...
          $this->config->faq_subtitle1 = 'Quiz Description';
          $this->config->faq_subtitle2 = 'Quiz Description';
          $this->config->faq_subtitle3 = 'Quiz Description';
          $this->config->faq_subtitle4 = 'Quiz Description';
