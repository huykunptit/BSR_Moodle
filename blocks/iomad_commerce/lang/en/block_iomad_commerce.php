...
$string['blocktitle'] = 'BSR E-Commerce';
...
$string['iomad_commerce:addinstance'] = 'Add a new BSR Ecommerce block';
...
$string['iomad_commerce:myaddinstance'] = 'Add a new BSR Ecommerce block to the users dashboard';
...
$string['opentoallcompanies_help'] = 'If this is disabled, then access to the shop can be turned on on a per company basis through the BSR control panel. If you enable it for the first time, you will then need to turn on the shop for the companies who require it.';
$string['or'] = 'or';
$string['order'] = 'Order';
...
$string['pluginname'] = 'BSR eCommerce';
$string['postcode'] = 'Postcode';
$string['pp_historic'] = 'Historic PayPal';
$string['pricefrom'] = 'From {$a}';
$string['priceoptions'] = 'Price options';
$string['privacy:metadata'] = 'The BSR E-Commerce block only shows data stored in other locations.';
