     ...
     <div class="container">
         <div class="row">
             <div class="col-lg-12 text-center">
               <h1 data-ccn="'.$fieldSlideTitle.'" class="banner-title">'.format_text($fieldSlideTitle, FORMAT_HTML, array('filter' => true)).'</h1>
...
// Normalize paths (optional step)
$normalizedCurrentPath = rtrim($currentPath, '/');

// Normalize allowed URLs (optional step)
$normalizedAllowedUrls = array_map(function($url) {
  return rtrim($url, '/');
}, $allowedUrls);

// Check if the current path is not in the allowed URLs
if (!in_array($normalizedCurrentPath, $normalizedAllowedUrls)) {
