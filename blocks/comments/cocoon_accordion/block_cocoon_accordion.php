...
class block_cocoon_accordion extends block_base {
    ...
    function specialization() {
        ...
        if (empty($this->config)) {
          ...
          $this->config->subtitle1 = 'Quiz Description';
          $this->config->subtitle2 = 'Quiz Description';
          $this->config->subtitle3 = 'Quiz Description';
          $this->config->subtitle4 = 'Quiz Description';
