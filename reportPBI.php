...
//     redirect($CFG->wwwroot .'/'. $CFG->admin .'/reportPBI.php');
// }

// If site registration needs updating, redirect.
// \core\hub\registration::registration_reminder('/reportPBI.php');
...
echo $OUTPUT->header();
echo '<p><iframe title="BSR E-Test Report R3" src = "https://app.powerbi.com/view?r=eyJrIjoiMmQ2YThhYzgtNzJkMC00ODA2LTkzMmEtYWMwYWRiZDQ3YzE2IiwidCI6ImFiZjU3NDE3LWYwMTQtNDExMC1iZGFkLTRlOTQ2OTU1YmVhZiIsImMiOjEwfQ==&pageName=8fd80648cb4ef138d7cf" width="1900" height="650" frameborder="0" allowfullscreen="true"></iframe></p>';
