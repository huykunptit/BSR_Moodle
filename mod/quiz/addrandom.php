...
$category = $_POST['category_'] ?? optional_param('cat', 0, PARAM_INT);
...
if ($data = $mform->get_data()) {
    if (!empty($data->existingcategory)) {
        ...
        $data->parent = $_POST['parent_'] ?? optional_param('parent', 0, PARAM_INT);
        $data->name = $_POST['name'] ?? optional_param('name', '', PARAM_TEXT);
