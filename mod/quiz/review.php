...
$downloadurl = new moodle_url('/mod/quiz/print_quizattempt.php', [
...
if (!empty($roleid) && is_numeric($roleid)) {
    ...
    if (!in_array($roleid, $restrictedRoles)) {
        $downloadbutton = html_writer::link($downloadurl, get_string('download', 'quiz'), ['class' => 'btn btn-primary']);
        $summarydata['download'] = [
            'title'   => get_string('download', 'quiz'),
