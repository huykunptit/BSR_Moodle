...
class user_bulk_form extends moodleform {
    ...
    public function definition() {
       ...
       $SESSION->bulk_users = $schoices;

       $HTTP_SESSION_VARS['bulk_users'] = $schoices;
//        dd($HTTP_SESSION_VARS['bulk_users']);
//        dd($schoices,$achoices);
        ...
        $grp =& $mform->addElement('group', 'buttonsgrp2', '', $objs, null, true);
