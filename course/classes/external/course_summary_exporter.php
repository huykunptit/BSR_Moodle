...
class course_summary_exporter extends \core\external\exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $end = gmdate('d-m-Y H:i:s', $this->data->enddate);
        if($end == '01-01-1970 00:00:00') {
            $end = 'Không giới hạn';
        }
        return array(
            ...
            'formated_startdate' => gmdate('d-m-Y H:i:s', $this->data->startdate),
            'formated_enddate' => $end,
        );
    }
    ...
    public static function define_other_properties() {
        return array(
            ...
            'formated_startdate' => array(
                'type' => PARAM_TEXT
            ),
            'formated_enddate' => array(
                'type' => PARAM_TEXT
            ),
        );
    }
