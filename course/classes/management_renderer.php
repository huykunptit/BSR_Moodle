    ...
    public function course_bulk_actions(core_course_category $category) {
        ...
        if ($category->can_move_courses_out_of()) {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                var btn = document.getElementById("showTreeButton");
                ...
                document.querySelectorAll(".modal-link").forEach(function(link) {
                    link.addEventListener("click", function(event) {
                        ...
                        var select = document.getElementById("menumovecoursesto");
                        if (select) {
                            select.value = value;
                            modal.style.display = "none";
            ...
            $submit = array('type' => 'submit', 'name' => 'bulkmovecourses', 'value' => get_string('move'),
                'class' => 'btn btn-secondary');
            // echo '<button  type = "button" id="showTreeButton" style="color:white;padding:10px;background: #1e4fa5;border-radius: 0.4em;border:solid #276ef8">Select category</button>';    
            $selectcategory = array('type' => 'button', 'id' => 'showTreeButton', 'value' => $name, 'class' => 'btn btn-secondary');
            $html.= html_writer::empty_tag('input', $selectcategory); 
            $html .= $this->detail_pair(
