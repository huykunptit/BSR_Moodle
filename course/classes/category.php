...
//        }
    ...
    public function update($data, $editoroptions = null) {
        ...
        // isquestionbank
        if (isset($data->isquestionbank)) {
            $newcategory->isquestionbank = $data->isquestionbank;
        } else {
            $newcategory->isquestionbank = 0;
        }
     ...
     * @return core_course_ccateategory[] Array of core_course_category objects indexed by category id
     */
