...
class question_engine_data_mapper {
    ...
    public function insert_question_attempt(question_attempt $qa, $context) {
        ...
        // check if that value exists in the database
        $record->id = $this->db->get_field('question_attempts', 'id', ['questionusageid' => $record->questionusageid, 'slot' => $record->slot]);
        if($record->id) {
    ...
    public function insert_question_attempt_step(question_attempt_step $step,
        ...
        // check if that value exists in the database
        $record->id = $this->db->get_field('question_attempt_steps', 'id', ['questionattemptid' => $questionattemptid, 'sequencenumber' => $seq]);
        if($record->id) {
