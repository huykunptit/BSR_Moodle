...
class qtype_truefalse extends question_type {
    public function save_question_options($question) {
        ...
        $answer->feedback = $this->import_or_save_files($question->correctfeedback,
        $context, 'question', 'answerfeedback', $answer->id);

                $answer->feedbackformat = isset($question->feedbacktrue) && is_array($question->feedbacktrue) ? $question->feedbacktrue['format'] : null;
