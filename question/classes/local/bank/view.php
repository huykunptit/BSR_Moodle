    ...
    protected function display_question_list($pageurl, $categoryandcontext, $recurse = 1, $page = 0,
        ...
        foreach ($questionsrs as $question) {
            if (!empty($question->id)) {
                $question->name = preg_replace('/^[^a-zA-Z0-9]+/', '', $question->name);
        ...
        usort($questionsArray, function($a, $b) {
            if($this->sort['qbank_viewquestionname\question_name_idnumber_tags_column-name'] == 1)
