...
class qbank_action_menu implements templatable, renderable {
    ...
    public function export_for_template(renderer_base $output): array {
        $questionslink = new moodle_url('/question/edit1.php', $this->currenturl->params());
        if (\core\plugininfo\qbank::is_plugin_enabled("qbank_managecategories")) {
            $categorylink = new moodle_url('/question/bank/managecategories/category1.php', $this->currenturl->params());
        }
        $importlink = new moodle_url('/question/bank/importquestions/import1.php', $this->currenturl->params());
        $exportlink = new moodle_url('/question/bank/exportquestions/export1.php', $this->currenturl->params());
